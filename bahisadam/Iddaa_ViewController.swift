...
class Iddaa_ViewController: ButtonBarPagerTabStripViewController, IndicatorInfoProvider {
    ...
    public func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "İddaa")
    }
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController]
    {
        ...
        let childOneVC = storyboard.instantiateViewController(withIdentifier: "betFirstTblViewController")
