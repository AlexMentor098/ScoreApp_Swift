...
class BA_PointsViewController: UIViewController {
	
	private let detailPageApi = BA_Server.PointsDetail
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		self.tabBarController?.navigationItem.title = "Turnuvalar"
