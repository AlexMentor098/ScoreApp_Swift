//
//  Marclar_FirstTableViewController.swift
//  bahisadam
//
...
class Marclar_FirstTableViewController: UIViewController, IndicatorInfoProvider {
    ...
    func tableView(_ tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tblMain.dequeueReusableCell(withIdentifier: "customCell")! as! Maclar_CustomCell
